...
public class Action_GatherResource : UGAction
{
	...
	public override void initaliseLocation(Vector3 position)
	{
		...
		try{
			positionOfStorehouse = BuildingStore.me.getNearestBuildingOfType ("Storehouse", this.gameObject.transform.position).getGoToTile().transform.position;
		}
		catch{
